		...
		<div class="usersView">
			...
			<div class="usersBox" v-if="tabIndex=='center'">
				<el-form class="usersForm" ref="userFormRef" :model="userForm" label-width="120px" :rules="rules">
					<el-row>
						<el-col :span="24">
							<el-form-item prop="jiashiyuanzhanghao" label="驾驶员账号">
								<el-input class="list_inp" v-model="userForm.jiashiyuanzhanghao" placeholder="驾驶员账号" readonly></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="24">
							<el-form-item prop="jiashiyuanmima" label="驾驶员密码">
								<el-input class="list_inp" v-model="userForm.jiashiyuanmima" placeholder="驾驶员密码" type="password"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="24">
							<el-form-item prop="jiashiyuanxingming" label="驾驶员姓名">
								<el-input class="list_inp" v-model="userForm.jiashiyuanxingming" placeholder="驾驶员姓名" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="24">
...
<script setup>
	...
	const updatePassword = async ()=>{
		passwordFormRef.value.validate(async (valid) => {
			if (valid) {
				if(passwordForm.value.mima != userForm.value.jiashiyuanmima){
				...
				userForm.value.jiashiyuanmima = passwordForm.value.newmima
				context?.$http({

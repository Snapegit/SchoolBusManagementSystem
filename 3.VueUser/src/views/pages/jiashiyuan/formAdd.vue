			...
			<el-row>
				...
				<el-col :span="24">
					<el-form-item label="驾驶员密码" prop="jiashiyuanmima">
						<el-input class="list_inp" v-model="form.jiashiyuanmima" placeholder="驾驶员密码"
							type="password" :readonly="!isAdd||disabledForm.jiashiyuanmima?true:false" />
					</el-form-item>
				</el-col>
				<el-col :span="24">
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='jiashiyuanmima'){
					form.value.jiashiyuanmima = row[x];
					disabledForm.value.jiashiyuanmima = true;
					continue;
				}

	...
	<div class="app-contain" :style='{"width":"100%","padding":"30px","margin":"10px auto","position":"relative"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">确认时间</div>
					<div  class="info_text" >{{detail.querenshijian}}</div>
				</div>
				<div class="btn_view">
					<el-button v-if="centerType&&(detail.ispay=='未支付'||!detail.ispay)&&btnFrontAuth('jiashiyuanquerenxinxi','支付')" class="approval_btn" @click="payClick">支付</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('jiashiyuanquerenxinxi','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('jiashiyuanquerenxinxi','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>

					...
					<el-col :span="24">
						<el-form-item label="头像" prop="touxiang">
							<uploads
								...
								@change="jiaozhigongtouxiangUploadSuccess">
							</uploads>
						</el-form-item>
					</el-col>
					<el-col :span="24">
					...
					<el-col :span="24">
						<el-form-item label="性别" prop="xingbie">
							<el-select 
								...
								placeholder="请选择性别"
								>
								<el-option v-for="item in jiaozhigongxingbieLists" :label="item" :value="item"></el-option>
							</el-select>
						</el-form-item>
					</el-col>
...
<script setup>
	...
	const tableName = ref('jiaozhigong')
	const user = ref({})
	const jiaozhigongxingbieLists = ref([])
	const init = () => {
		jiaozhigongxingbieLists.value = "男,女".split(',')
	}
	const jiaozhigongtouxiangUploadSuccess=(fileUrls)=> {

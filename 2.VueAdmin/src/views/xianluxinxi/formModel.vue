				...
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="路线详情" prop="luxianxiangqing">
							<editor :value="form.luxianxiangqing" placeholder="请输入路线详情" :readonly="!isAdd||disabledForm.luxianxiangqing?true:false"
								class="list_editor" @change="(e)=>editorChange(e,'luxianxiangqing')"></editor>
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.luxianxiangqing = res.data.data.luxianxiangqing?(res.data.data.luxianxiangqing.replace(reg,'../../../cl39466158/file')):'';

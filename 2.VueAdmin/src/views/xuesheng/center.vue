				...
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="学生账号" prop="xueshengzhanghao">
							<el-input class="list_inp" v-model="user.xueshengzhanghao" readonly placeholder="学生账号" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="24">
...
<script setup>
	...
	const onSubmit = () => {
		...
		if((!user.value.xueshengzhanghao)){
			context?.$toolUtil.message(`学生账号不能为空`,'error')
			return false
		}
		if((!user.value.mima)){
